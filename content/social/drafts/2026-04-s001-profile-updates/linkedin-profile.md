# LinkedIn Profile — Complete Update Draft

- **Sprint**: S-001 / T5
- **Agent**: CommunityManager
- **Date**: 2026-04-20
- **Subject**: Dídac Llorens (`linkedin.com/in/didacllorens`)
- **Inputs**: T3 profile audit, T4 positioning synthesis, brand.md, style-book.md, marketing.md

---

## 1. Name and Lore Line

**Name field**: Dídac Llorens

**Pronunciation guide** (name pronunciation feature):
> dee-DAHK yoh-RENS

**Professional suffix**: None. Do not add "BSc" until the degree is conferred (Feb 2027). After conferral: "Dídac Llorens, BSc".

---

## 2. Headline

> **~120 characters. No emoji. No code syntax. Searchable keywords.**

### Option A — ML/Data Forward (recommended, aligns with Primary Angle A)

```
Software Engineering · ML/AI (UOC, 2027) · Data & Systems · Python · Java · Barcelona
```

(89 chars)

### Option B — Agentic Systems Forward (aligns with Secondary Angle B)

```
Software Engineering · Agentic Systems & ML/AI (UOC, 2027) · Python · Java · Barcelona
```

(89 chars)

### Option C — Balanced / Generalist

```
Software Engineering Student (UOC, ML/AI 2027) · Systems & Tooling · Python · Java · Barcelona
```

(96 chars)

**Rationale**: All three options replace the current `MicroServices || Back-End Developer && Java lover ❤️`. They remove code-syntax gimmicks, add the ML/AI credential, include Barcelona for geographic search, and lead with the degree. Option A is recommended because it positions for the highest-return job market lane (ML/Data Engineering, 10% YoY salary growth — T1 §1). Option B is recommended if targeting BSC-CNS or HP GenAI Lab specifically.

**Source**: T3 §1.1, T4 §5.2, brand.md §Positioning.

---

## 3. About Section

> **Target: ~2000 characters. Three paragraphs. No apology framing.**

### Option A — ML/Data Engineering Lead
...
**Source**: T4 §5.2 (LinkedIn directives), brand.md §Positioning, style-book.md §4.1 (lead with what you built).

---

## 4. Featured Section

> **Pin 2–3 items in this order.**

| Order | Item | Type | Link | Why |
|-------|------|------|------|-----|
| 1 | **AgenticCareerBoost** | Repository / External link | `https://github.com/DidacLL/AgenticCareerBoost` | Flagship project. Demonstrates agentic systems thinking, documentation discipline, and ML-adjacent engineering. The README is recruiter-scannable. |
...
### 5.1 New Entry: Independent Engineering Projects (2020–Present)

> **Title**: Software Engineering — Independent Projects & Research
...
→ Designed and built **AgenticCareerBoost**, a path-based, model-agnostic multi-agent operating system with 6 agent roles, 7 workflow contracts, and formal truth hierarchy. Architecture decisions documented in inspectable Markdown files. Published formal engineering reports (LaTeX/PDF). [Link: github.com/DidacLL/AgenticCareerBoost]

→ Created **P3CTeX**, a custom LaTeX document class and package ecosystem for academic document production. Multi-package architecture with expl3 internals, automated test suites, and agentic development workflows. 2 GitHub stars (organic). [Link: github.com/DidacLL/P3CTeX]

→ Built **IronBank**, a Java/Spring Boot microservices banking simulation with Keycloak authentication, OpenAPI documentation, and multi-service architecture as IronHack bootcamp capstone (2022). [Link: github.com/DidacLL/Ironhack-IronBank_FinalProject_vBNKsys]
...
> Consolidate the 15 years into **1–2 grouped entries** that emphasize transferable engineering-relevant skills. Do NOT delete these entries — they demonstrate range and reliability.
...
→ Served as primary point of contact for stakeholder escalations — translating technical issues into business language for management and regulatory reporting.

**Source**: T3 §1.4, T4 §5.2 C3/M4. Note: "Never delete the non-tech experience — it demonstrates range and reliability" (T3 §1.4).

---

## 6. Skills Priority List

> **Top 20 skills in priority order. Python must be in top 3 for Angle A positioning.**

| Priority | Skill | Rationale |
|----------|-------|-----------|
| 1 | **Python** | Primary language for ML/Data roles (Angle A). Must be top for LinkedIn search. |
...
| 9 | **REST APIs** | Standard backend skill. IronBank project evidence. |
| 10 | **Docker** | Container fundamentals. Required for ML deployment pipeline (GP-02). |
| 11 | **Systems Design** | Core brand positioning. AgenticCareerBoost is the evidence. |
| 12 | **Microservices** | IronBank project. Relevant for backend/platform roles. |
| 13 | **Kotlin** | Android bootcamp (Fundación Francisco Puerto). JVM-adjacent. |
| 14 | **Object-Oriented Programming** | Foundational. Java + Kotlin demonstrate this. |
| 15 | **Design Patterns** | Engineering maturity signal. Architecture decisions in repos. |
| 16 | **Technical Writing** | LaTeX reports, README quality, agentic system documentation. |
| 17 | **Data Structures & Algorithms** | UOC coursework. CS degree signal. |
| 18 | **Agile / Scrum** | Sprint-based workflow in AgenticCareerBoost. Industry standard. |
| 19 | **Artificial Intelligence** | UOC specialization. AgenticCareerBoost evidence. |
| 20 | **React** | ITAcademy FullStack bootcamp. Broadens full-stack signal. |

**Action**: Remove or deprioritize any skills currently listed that are not in this table (e.g., HTML, CSS as standalone skills). Endorse Python, Machine Learning, and Java as the top 3 — ask contacts to endorse these specifically.

**Source**: T3 §1.6, T4 §5.2 M2.

---

## 7. Education Section Updates

### 7.1 UOC — Software Engineering (Grau en Enginyeria Informàtica)
...
> **Current count: 0. Target: 3–5.**

| Source | Ask Framing | Priority |
|--------|-------------|----------|
...
## 9. Profile Photo and Banner

> **Not assessed in T3 scrape. Manual verification required.**
...
## 10. Activity / Posting Cadence

> **Current state: zero original posts since ~2023. Only passive likes.**

**Immediate actions**:
1. Begin posting 2x/month minimum (style-book.md §7 specifies 2x/week as aspirational target — start with 2x/month and increase).
2. Follow the Tuesday (narrative) + Thursday (technical artifact) cadence from style-book.md §7.
...
- [x] Tone consistent with `docs/core/brand.md` — technical, disciplined, direct
- [x] No "excited to announce" or celebration-without-proof
- [x] No AI-hype language
- [x] No founder-LARP framing
