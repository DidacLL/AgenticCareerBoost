...
| 4 | Recruiter landing fast rebuild | Developer | Static site | Build fair-ready landing page with JSON-LD, OG tags, projects, curriculum, PDF CV link, contact, and current links | site/public/**, site/starter/**, content/site/** | 90-second recruiter scan works; no active legacy-site link; curriculum and CV path exist | none | site/public/index.html |
