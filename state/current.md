...
- Execution-mode guardrail: `docs/core/execution-modes.md`.
- Public-copy guardrail: `docs/core/public-copy.md`.
- AgenticSystem refactor run ledger: `state/logs/agentic-system-refactor-run.md`.
...
- Profile consistency package and LinkedIn reactivation drafts exist as human-gated candidate artifacts.
