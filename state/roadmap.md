...
Upcoming sprint seeds. Each becomes a full plan via the Plan workflow.
...
| S-001.5 | UOC fair public profile cleanup | **REVIEWED / DEPLOY PENDING** — event target shortlist, GitHub cleanup package, recruiter landing page, curriculum/CV, LinkedIn/JobTeaser kit, outreach kit; pending commit/push and GitHub Pages check |
| S-002 | Site rebuild (Jekyll) | Expand the fair-ready landing page into full project subpages, CV hardening, stable assets, and richer AI-readable metadata |
