# Non-authoritative origin evidence

This file is retained to document the repository bootstrap origin. It is not an
active rule file and must not override `AGENTS.md` or `agents/rules/**`.
