...
copying. Protected `main` never needs a bot auto-commit. The smoke test and CV
sources compile, but they are not promoted as public report artifacts. Generated
PDFs and auxiliary files must not be tracked inside `agents/reports/tex/`.
