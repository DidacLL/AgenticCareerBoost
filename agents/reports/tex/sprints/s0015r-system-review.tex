...
\midrule
Research & \pathref{agents/state/research/s0015-uoc-fair-targets.md} & Rank UOC fair targets by fit, message angle, and risk. \\
GitHub profile & \pathref{agents/work/social/drafts/2026-04-s0015-github-cleanup.md} & Prepare README, bio, repo descriptions, topics, pin order, and archive guidance. \\
Site & \pathref{site/} & Provide a 90-second recruiter scan with JSON-LD, project evidence, CV link, and contact route. \\
CV & \pathref{agents/reports/tex/guides/didac-llorens-cv.tex} & Produce a formal CV aligned with the ML/Data plus Agentic Systems posture. \\
LinkedIn/JobTeaser & \pathref{agents/work/social/drafts/2026-04-s0015-linkedin-jobteaser-kit.md} & Supply paste-ready profile copy without unsupported credentials. \\
Outreach & \pathref{agents/work/social/drafts/2026-04-s0015-uoc-fair-outreach.md} & Draft event intros, interview requests, follow-ups, and company-specific angles. \\
Execution & \pathref{agents/state/summaries/s0015-execution-checklist.md} & Separate local repository work from user-controlled external account actions. \\
\bottomrule
\end{tabularx}
\end{table}
...
intended publication folder is \pathref{site/files/reports/} and local TeX
output belongs under \pathref{agents/reports/tex/build/}. This matters because
...
files live under \pathref{agents/reports/tex/}; local build output goes to
\fname{agents/reports/tex/build/}; promoted public PDFs go to
\pathref{site/files/reports/}. S-001.5R should preserve that separation.
...
The companion governance log, \pathref{agents/state/logs/S-001.5R/ci-pages-governance.md},
