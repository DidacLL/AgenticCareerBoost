...
% Human-facing narrative opener for the main CV column. Tailored CVs should use
% this immediately after \small, before the first main section.
\newcommand{\cvAbstract}[1]{%
  \vspace{0.18em}%
  {\small #1\par}%
  \vspace{0.34em}%
}
...
% ATS/AI-readable support surface. It repeats only evidence-backed information;
% role-specific terms come from \cvsetup and must not be used to create claims.
\newcommand{\cvParserSummary}{%
  \resizebox{0pt}{!}{%
    \textcolor{white}{%
      ...
      Evidence-backed role keywords: \cvRoleKeywords.
    }%
  }%
}
