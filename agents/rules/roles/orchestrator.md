...
- `agents/rules/workflows/*` — active workflow contract
...
- `agents/rules/core/*` — stable truth (never modify)
- PairCheck verdicts — to decide accept, re-delegate, or escalate

## Writes

- `agents/state/active-sprint.md` — status and plan-pointer updates
- `agents/state/current.md` — workflow status changes
...
- Override `agents/rules/core/*` without a system-review workflow
