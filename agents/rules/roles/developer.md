...
- `agents/rules/core/execution-modes.md` — mode-specific allowed and forbidden writes
- `agents/rules/core/*` — constraints and mission (read-only)
...
- Modify `agents/rules/core/*`, `agents/rules/workflows/*`, or `agents/rules/roles/*` outside an
